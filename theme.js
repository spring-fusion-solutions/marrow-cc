...
export const ASSETS = {
  ...
  squad: [
    { id: 1,  name: 'Abdul Wahhab',   role: 'Captain / All-Rounder', number: 18, image: '' },
    ...
    { id: 11, name: 'Player Eleven',  role: 'Tailender',              number: 21, image: '' },
  ],
};
...
export const SOCIAL = {
  ...
  whatsapp:  'https://wa.me/94XXXXXXXXX',  // Replace with real number
};
