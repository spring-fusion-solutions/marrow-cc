...
export const ASSETS = {
  ...
  squad: [
    ...
    { id: 3,  name: 'Thasleem',    role: 'Fast Bowler',            number: 11,  image :new URL('../assets/thasleem.jpeg', import.meta.url).href },
    { id: 4,  name: 'Khaiz',    role: 'Wicket Keeper',          number: 4,  image :new URL('../assets/kaiz.jpeg', import.meta.url).href },
    ...
    { id: 11,  name: 'Abdul Malik',    role: 'Fast bowler',          number: 4,  image: '' },
