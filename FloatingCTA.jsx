...
/**
 * FloatingCTA — future-ready tournament registration button.
 * Shows after user scrolls past hero.
 * When ENABLE_TOURNAMENT_REGISTRATION = true, connects to backend.
 */
const ENABLE_TOURNAMENT_REGISTRATION = false; // ← flip to true when backend is ready
...
export default function FloatingCTA() {
  ...
  return (
    <>
      ...
      {/* Tournament Modal — placeholder for future backend integration */}
      <AnimatePresence>
        {modalOpen && (
          <motion.div
